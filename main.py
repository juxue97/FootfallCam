...
def display(frame):
    ...
    #_line_up 
    #cv.line(object.frame, start_point_u, end_point_u, (0,0,255), 5)
    #cv.putText(frame , 'In', (start_point_u[0], start_point_u[1]-15), cv.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)

    #cv.rectangle(frame,(575,255),(755,285),(0,0,255),3)

    #_line_bot
    #cv.line(object.frame, start_point_b, end_point_b, (255,0,), 5)
    #cv.putText(frame , 'Out', (start_point_b[0], start_point_b[1]-15), cv.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
